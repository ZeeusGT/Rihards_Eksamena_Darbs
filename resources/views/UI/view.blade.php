...
<head>
    ...
    <link rel="stylesheet" href="/public/song_view_dependencies/styles/song_view_styles.css">
    <script src="/public/song_view_dependencies/js/song_view_scripts.js"></script>
</head>
</head>
<body>
...
<div id="Animated_Box" class="Div_Container">
        @if(Auth::id() == $Current_Song->Owners_ID || Auth::user()->isAdmin)
        <div id="EditIcon">
